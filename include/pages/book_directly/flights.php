		...
		<div style="height:40px; margin-top:3px;">
			<table class="full_width">
				<tr>
					...
					<td style="text-align:left; width: 110px;"><label class="radio-inline" style="float:none;"><input type="radio" id="tripType2" name="gr" value="option2"><span class="check"></span>&nbsp;&nbsp;one way</label></td>
					<td style="text-align:left; width: 120px;"><label class="radio-inline" style="float:none;"><input type="radio" id="tripType3" name="gr" value="option3"><span class="check"></span>&nbsp;&nbsp;multi city</label></td>
				</tr>
			</table>
		</div>
		<div class="clearfix"></div>
