...
<div class="column_content padding_column_content full_height">
	...
	<h1 class="pull-right nomargin_right">Paris info</h1>
	<div class="clearfix"></div>
	...
	<a id="demo" href="page1_1_1.php"><img class="img-responsive" src="images/paris.png" alt="" /></a>
</div>
...
<script>
	/*$('#demo').click(function(event){
		...
		var url = 'ajax/new/sort_flight.php';
