<div class="container-fluid">
	<?php for ($i=1; $i<=10; $i++) { ?>
		<div class="row">
			<div id="hotel<?php echo $i; ?>" class="hotel_detail type2">
				<p>Radisson Blu Edwardian Berkshire <?php echo $i; ?></p>
				...
				<table>
					...
					<tr>
						<td class="special_link" colspan="2" style="padding-top:5px;">
							<a href="#" class="map">map view</a> | <a class="flight" href="#">flight included</a>
						</td>
					</tr>
				</table>
			</div>
