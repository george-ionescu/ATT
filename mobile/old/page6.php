		        ...
		        <div class="column_content nopadding full_height">
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but1" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-6" href="ajax/pages/overview.php">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but2" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-6" href="ajax/pages/account.php">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but3" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-3" href="ajax/pages/travel_preferences.php">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but4" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-3" href="ajax/pages/history.php">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but5" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-3" href="ajax/pages/recent_searches.php">
					...
					<div class="row">
						<div class="col-md-12 nopadding">
							<a id="but6" class="slide button_big account_sidebar pull-right" column-close="column2" column-open="column2" column-class="col-md-3" href="ajax/pages/favorite_hotels.php">
