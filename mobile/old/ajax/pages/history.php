        ...
        <div class="column_content nopadding full_height">
	    	<div class="row">
				<div class="col-md-12 nopadding">
					<a id="but1" class="slide button_big pull-right account_overview" column-close="column3" column-open="column3" href="ajax/pages/history_info.php">
			...
			<div class="row">
				<div class="col-md-12 nopadding">
					<a id="but2" class="slide button_big pull-right account_overview" column-close="column3" column-open="column3" href="ajax/pages/history_info.php">
			...
			<div class="row">
				<div class="col-md-12 nopadding">
					<a id="but3" class="slide button_big pull-right account_overview" column-close="column3" column-open="column3" href="ajax/pages/history_info.php">
