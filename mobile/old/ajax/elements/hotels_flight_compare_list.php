	...
	<?php for ($i=1; $i<=10; $i++) { ?>
		<div class="row">
			<div id="hotel<?php echo $i; ?>" class="hotel_detail type1">
				<p>Radisson Blu Edwardian Berkshire <?php echo $i; ?>cf</p>
				...
				<table>
					...
					<tr>
						<td class="special_link" colspan="2" style="padding-top:5px;">
							<a href="#" class="map">map view</a> | <a class="compare" href="#">compare price</a> | <a class="flight" href="#">flight included</a>
						</td>
					</tr>
				</table>
			</div>
