	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
		    ...
		    if (api.options.next_prev_thumb){
	 	...
	 	beforeAnimation : function(direction){
		    if (api.options.progress_bar && !vars.is_paused) $(vars.progress_bar).stop().css({left : -$(window).width()});
		  	...
		  	// Update slide caption
		   	...
		   	if ($(vars.slide_caption_sub).length){
		   		(api.getField('subtitle')) ? $(vars.slide_caption_sub).html(api.getField('subtitle')) : $(vars.slide_caption_sub).html('');
		   	}
		   	// Update slide url
		   	if ($(vars.slide_caption).length){
		   		(api.getField('url')) ? $(vars.slide_caption).attr('href', api.getField('url')) : $(vars.slide_caption).attr('href', '#');
		   	}
		    // Update slide number
	 ...
	 $.supersized.themeVars = {
		...
		next_prev_thumb		: 	true,				// enable/disable next/prev buttons
		...
		slide_caption_sub	:	'#slide_subtitle',	// Slide subtitle
